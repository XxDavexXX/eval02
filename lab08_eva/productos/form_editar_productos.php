            ...
            if(isset($_GET['x'])) {
                ...
                if ($res) {
                        while($row = mysqli_fetch_assoc($res)) {
                            ...
                            echo '<input type="text" name="nombre" placeholder="Nombre de Producto"  value="'.$row["nombre"].'" required="required" />';
                            echo '<input type="text" name="descripcion" placeholder="Desscripción"  value="'.$row["descripcion"].'" required="required" />';
                            echo '<input type="text" name="stock" placeholder="Stock"  value="'.$row["stock"].'" required="required" />';
                            echo '<input type="text" name="precio_venta" placeholder="Precio Venta"  value="'.$row["precio_venta"].'" required="required" />';
                        }
                } else {
